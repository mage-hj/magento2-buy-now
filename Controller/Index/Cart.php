...
namespace Techsevin\BuyNow\Controller\Index;
...
/**
 * Class Cart
 * @package Techsevin\BuyNow\Controller\Index
 */
class Cart extends \Magento\Wishlist\Controller\Index\Cart
{
    ...
    /**
     * @var \Techsevin\BuyNow\Helper\Data
     */
     ...
     * @param \Techsevin\BuyNow\Helper\Data $buynowHelper
    ...
    public function __construct(
        ...
        \Techsevin\BuyNow\Helper\Data $buynowHelper
    ) {
    ...
    public function execute()
    {
        ...
        try {
            ...
            $cartProducts = $this->buynowHelper->getConfig('buynow/advance/keep_cart_products');
            if (!$cartProducts) {
                $this->cart->truncate(); //delete every item from cart
            }
